...
export class HomeComponent implements OnInit, OnDestroy {
  ...
  //   modalRef.componentInstance.cancelButtonLabel = 'Cancel';
  //   modalRef.componentInstance.message = `Videos on Gamble social home are limited to 2 Minutes!
  ...
  addDefaultImageIfNeeded(profile): any[] {
    if (!profile.profilePictures || profile.profilePictures.length === 0) {
      profile.profilePictures = [
        {
          imageUrl: '/assets/images/landingpage/Gamble-Social-Square-Logo.png',
        },
      ];
    }
