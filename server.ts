...
export function app(): express.Express {
  ...
  const distFolder = join(process.cwd(), 'dist/gamble-social/browser');
  ...
  const template = fs
    .readFileSync(
      path.join(
        join(process.cwd(), 'dist/gamble-social/browser'),
        'index.html'
      )
    )
    .toString();
    ...
    res.render(
      ...
      async (err, html) => {
        ...
        var seo: any = {
          ...
          image:
            'https://www.gamble.social/assets/images/landingpage/OD-default-profile.png',
